  ...
  <div class="container mt-5">
    ...
    <div class="row">
      <div class="col form-inline">
        <b-button id="show-btn" variant="dark" class="dark  border rounded-0 outline-dark" @click="showModal">Ajouter</b-button>
        <!-- BEGIN MODAL -->
            ...
            <b-form @submit="add">
             ...
             <b-form-select 
              ...
              :options="priorityOptions">
                ...
                <b-button type="submit" variant="dark" class="ml-3 dark  border rounded-0 outline-dark"
                >Ajouter</b-button
              >
            </b-form>
          </div>
    ...
    <div class="row mt-5">
      <div class="col-3">
        <div class="p-2 alert alert-secondary">
          ...
          >
            <div
              class="list-group-item  border rounded-0"
